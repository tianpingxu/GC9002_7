...
#define CONFIG_CONSOLE_DEBUG_UART       UART2
#define CONFIG_FPGA_SOC                 USE_FPGA_SOC
#ifdef CONFIG_FPGA_SOC
...
#define CONFIG_CQSPIFLASH			1U

/* Define this macro will open Watch dog in APP */
//#define WATCH_DOG_CPU1

#ifdef CHIP_GC9002_NoHyper
#define CONFIG_BOOT_DCACHE_DISABLE	1U
#define CONFIG_NUTTXMM_NONE
#endif
