...
#ifdef  _TEMPLATE_LCD_QSPI_ST77903_
...
int main(void)
{
    ...
    display_st77903_init(&hdisplay, NULL);
    display_st77903_slave_passive(&hdisplay, NULL);
    // display_st77903_master_active();
	while(1)
	{
		tmp = -(i << 16);
...
#endif/* _TEMPLATE_LCD_QSPI_ST77903_ */
#endif/* BSP_DEBUG */