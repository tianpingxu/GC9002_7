 ...
 * Change Logs:
 * Date           Author       Notes
 * 2022-09-06     mazy         the first version
 */
...
#ifdef PHY_USING_RTL8211E
#define PHY_Status_REG              0x11U
#define PHY_SPEED_MASK              (0xC0)
#define PHY_Status_SPEED_10M(sr)    (!((sr) & PHY_SPEED_MASK))
#define PHY_Status_SPEED_100M(sr)   (((sr) & PHY_SPEED_MASK) == 0x40)
#define PHY_Status_SPEED_1000M(sr)  (((sr) & PHY_SPEED_MASK) == 0x80)
#define PHY_FULL_DUPLEX_MASK        (1<<13)
#define PHY_Status_FULL_DUPLEX(sr)  ((sr) & PHY_FULL_DUPLEX_MASK)
/*  The PHY interrupt source flag register. */
#define PHY_INTERRUPT_FLAG_REG      0x13U
#define PHY_LINK_CHANGE_FLAG        (1<<10)
/*  The PHY interrupt control register. */
#define PHY_INTERRUPT_CTRL_REG      0x12U
#define PHY_INTERRUPT_EN            (1<<10)
/*  The PHY interrupt mask register. */
#define PHY_INTERRUPT_MASK_REG      0x12U
#define PHY_INT_MASK                (1<<10)
#endif /* PHY_USING_RTL8211E */
