...
#define configGENERATE_RUN_TIME_STATS 	 0	/* Integration Test change 0 to 1 */

#if ( configGENERATE_RUN_TIME_STATS == 1 )
#define configUSE_STATS_FORMATTING_FUNCTIONS 1
extern volatile uint32_t ITM_u32Tick;
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS()    (ITM_u32Tick = 0ul)
#define portGET_RUN_TIME_COUNTER_VALUE()            (ITM_u32Tick)
#endif
...
to zero. */
#define configASSERT( x ) if( ( x ) == 0 ) { taskDISABLE_INTERRUPTS(); for( ;; ); }   /* close it if release to Customer */
/*
