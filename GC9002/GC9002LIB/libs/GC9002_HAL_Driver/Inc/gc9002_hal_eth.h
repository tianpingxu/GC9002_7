/**
  ******************************************************************************
  * @file    gc9005_hal_eth.h
  * @author  GraphichinaSX Team
  * @version V1.0.0
  * @date    2022-10-18
  * @brief   This file contains all the functions prototypes for the GMAC
  *          firmware library.
  ******************************************************************************
  */
...
#ifndef __GC9005_HAL_ETH_H__
#define __GC9005_HAL_ETH_H__
...
#define ETH_MACMIIAR_CR_MASK    0xFFFFFFC3U
...
#endif /* USE_HAL_ETH_REGISTER_CALLBACKS */
{
  ...
  __IO HAL_LockTypeDef       Lock;          /*!< ETH Lock                    */
...
/**
  * @}
  */
/** @defgroup ETH_Port_Select port select
  * @{
  */
#define ETH_PORT_SELECT_1000M          0x00000000U
#define ETH_PORT_SELECT_10_OR_100M     0x00008000U
...
/** @defgroup ETH_Speed ETH Speed
  * @{
  */
#define ETH_SPEED_10M        0x00008000U
#define ETH_SPEED_100M       0x0000C000U
...
#define ETH_MEDIA_INTERFACE_RMII      0x00000000U
...
/** @defgroup ETH_Frame_Burst ETH Frame Burst
  * @{
  */
#define ETH_FRAME_BURST_ENABLE    0x00200000U
#define ETH_FRAME_BURST_DISABLE   0x00000000U
/**
  * @}
  */
...
/** @defgroup ETH_Pass_Control_Frames ETH Pass Control Frames
  * @{
  */
#define ETH_PASSCONTROLFRAMES_BLOCKALL                0x00000000U  /*!< MAC filters all control frames from reaching the application */
#define ETH_PASSCONTROLFRAMES_FORWARDALL              0x00000040U  /*!< MAC filters all control frames from reaching the application */
#define ETH_PASSCONTROLFRAMES_FORWARDALLTOAPP         0x00000080U  /*!< MAC forwards all control frames to application even if they fail the Address Filter */
