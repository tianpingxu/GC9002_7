...
#ifndef __GC90XX_HAL_TIM_H__

#define __GC90XX_HAL_TIM_H__
...
#if(defined BSP_TIM_DMA_ENABLE && BSP_TIM_DMA_ENABLE == 1U)
...
/**
  * @brief  Get the TIM peripheral is enabled.
  * @param  __HANDLE__ TIM handle
  * @retval None
  */
#define __HAL_GET_TIM_IS_ENABLED(__HANDLE__)        (((__HANDLE__)->Instance->CR1 & (TIM_CR1_CEN)) != 0)
