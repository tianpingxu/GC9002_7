...
typedef struct {                                    /*!< USB0 Structure                                                        */
  ...
  __IO uint8_t   FADDR;                             /*!< USB Device Functional Address                          offset = 0x00  */
  __IO uint8_t   POWER;                             /*!< USB Power                                                             */
  __IO uint16_t  TXIS;                              /*!< USB Transmit Interrupt Status                                         */
  __IO uint16_t  RXIS;                              /*!< USB Receive Interrupt Status                                          */
  __IO uint16_t  TXIE;                              /*!< USB Transmit Interrupt Enable                                         */
  ...
  __IO uint16_t  FRAME;                             /*!< USB Frame Value                                                       */
  __IO uint8_t   EPIDX;                             /*!< USB Endpoint Index                                                    */
  __IO uint8_t   TEST;                              /*!< USB Test Mode                                          offset = 0x0F  */

  //Indexed Endpoint Control/Status registers
  __I  uint32_t  RESERVED0[4];                      /*!< RESERVED 16 BYTES                                      offset = 0x10  */

  //FIFOs
 union {
    __IO uint8_t   FIFO0_BYTE;                      /*!< USB FIFO Endpoint 0                                    offset = 0x20  */
    __IO uint16_t  FIFO0_HALF;                      /*!< USB FIFO Endpoint 0                                                   */
    __IO uint32_t  FIFO0_WORD;                      /*!< USB FIFO Endpoint 0                                                   */
  } FIFO0;
  union {
  ...
  __I  uint32_t  RESERVED1[8];                      /*!< RESERVED 32 BYTES                                                     */

  //Additional Control and Configuration registers
  __IO uint8_t   DEVCTL;                            /*!< USB Device Control                                     offset = 0x60  */
  __IO uint8_t   CCONF;                             /*!< USB Common Configuration                                              */
  __IO uint8_t   TXFIFOSZ;                          /*!< USB Transmit Dynamic FIFO Sizing                                      */
  __IO uint8_t   RXFIFOSZ;                          /*!< USB Receive Dynamic FIFO Sizing                                       */
  __IO uint16_t  TXFIFOADD;                         /*!< USB Transmit FIFO Start Address                                       */
  __IO uint16_t  RXFIFOADD;                         /*!< USB Receive FIFO Start Address                                        */
  __I  uint32_t  RESERVED2[2];                      /*!< RESERVED 8 BYTES                                                      */
  __IO uint8_t   ULPIVBUSCTL;                       /*!< USB ULPI VBUS Control                                  offset = 0x70  */
  __I  uint8_t   RESERVED3[3];                      /*!< RESERVED 3 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED4;                         /*!< RESERVED 1 BYTES                                                      */
  __IO uint8_t   EPINFO;                            /*!< USB Endpoint Information                                              */
  __IO uint8_t   RAMINFO;                           /*!< USB RAM Information                                                   */
  ...
  __IO uint8_t   FSEOF;                             /*!< USB Full-Speed Last Transaction to End of Frame Timing                */
  __IO uint8_t   LSEOF;                             /*!< USB Low-Speed Last Transaction to End of Frame Timing                 */
  __I  uint8_t   RESERVED5;                         /*!< RESERVED 1 BYTES                                                      */
  __IO uint8_t   TXFUNCADDR0;                       /*!< USB Transmit Functional Address Endpoint 0                            */
  __I  uint8_t   RESERVED6;                         /*!< RESERVED 1 BYTES                                         SOFT_RST     */

  //Target Endpoint Control Registers
  __IO uint8_t   TXHUBADDR0;                        /*!< USB Transmit Hub Address Endpoint 0                    offset = 0x80  */
  __IO uint8_t   TXHUBPORT0;                        /*!< USB Transmit Hub Port Endpoint 0                                      */
  __I  uint32_t  RESERVED7;                         /*!< RESERVED 4 BYTES                                                      */
  __IO uint8_t   TXFUNCADDR1;                       /*!< USB Transmit Functional Address Endpoint 1                            */
  __I  uint8_t   RESERVED8;                         /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED9;                         /*!< RESERVED 1 BYTES                                                      */
  __IO uint8_t   RXHUBADDR1;                        /*!< USB Receive Hub Address Endpoint 1                                    */
  __IO uint8_t   RXHUBPORT1;                        /*!< USB Receive Hub Port Endpoint 1                                       */
  __IO uint8_t   TXFUNCADDR2;                       /*!< USB Transmit Functional Address Endpoint 2             offset = 0x90  */
  __I  uint8_t   RESERVED10;                        /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED11;                        /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED12;                        /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED13;                        /*!< RESERVED 1 BYTES                                                      */
  __IO uint8_t   RXHUBADDR3;                        /*!< USB Receive Hub Address Endpoint 3                                    */
  __IO uint8_t   RXHUBPORT3;                        /*!< USB Receive Hub Port Endpoint 3                                       */
  __IO uint8_t   TXFUNCADDR4;                       /*!< USB Transmit Functional Address Endpoint 4             offset = 0xA0  */
  __I  uint8_t   RESERVED14;                        /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED15;                        /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED16;                        /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED17;                        /*!< RESERVED 1 BYTES                                                      */
  __IO uint8_t   RXHUBADDR5;                        /*!< USB Receive Hub Address Endpoint 5                                    */
  __IO uint8_t   RXHUBPORT5;                        /*!< USB Receive Hub Port Endpoint 5                                       */
  __IO uint8_t   TXFUNCADDR6;                       /*!< USB Transmit Functional Address Endpoint 6             offset = 0xB0  */
  __I  uint8_t   RESERVED18;                        /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED19;                        /*!< RESERVED 1 BYTES                                                      */
  __IO uint8_t   RXHUBADDR6;                        /*!< USB Receive Hub Address Endpoint 6                                    */
  __IO uint8_t   RXHUBPORT6;                        /*!< USB Receive Hub Port Endpoint 6                                       */
  __IO uint8_t   TXFUNCADDR7;                       /*!< USB Transmit Functional Address Endpoint 7             offset = 0xB8  */
  __I  uint8_t   RESERVED20;                        /*!< RESERVED 1 BYTES                                                      */
  ...
  __I  uint8_t   RESERVED21;                        /*!< RESERVED 1 BYTES                                                      */
  __IO uint8_t   RXHUBADDR7;                        /*!< USB Receive Hub Address Endpoint 7                                    */
  __IO uint8_t   RXHUBPORT7;                        /*!< USB Receive Hub Port Endpoint 7                                       */
  __I  uint32_t  RESERVED22[16];                    /*!< RESERVED 64 BYTES                                      offset = 0xC0  */

  //Non-Indexed Endpoint Control/Status registers
  __I  uint16_t  RESERVED23;                        /*!< RESERVED 2 BYTES                                       offset = 0x100 */
  __O  uint8_t   CSRL0;                             /*!< USB Control and Status Endpoint 0 Low                                 */
  __O  uint8_t   CSRH0;                             /*!< USB Control and Status Endpoint 0 High                                */
  __I  uint16_t  RESERVED24[2];                     /*!< RESERVED 4 BYTES                                                      */
  __IO uint8_t   COUNT0;                            /*!< USB Receive Byte Count Endpoint 0                                     */
  __I  uint8_t   RESERVED25;                        /*!< RESERVED 1 BYTES                                                      */
  __IO uint8_t   TYPE0;                             /*!< USB Type Endpoint 0                                                   */
  __IO uint8_t   NAKLMT;                            /*!< USB NAK Limit                                                         */
  __I  uint32_t  RESERVED26;                        /*!< RESERVED 4 BYTES                                                      */
  __IO uint16_t  TXMAXP1;                           /*!< USB Maximum Transmit Data Endpoint 1                                  */
  __IO uint8_t   TXCSRL1;                           /*!< USB Transmit Control and Status Endpoint 1 Low                        */
  __IO uint8_t   TXCSRH1;                           /*!< USB Transmit Control and Status Endpoint 1 High                       */
  __IO uint16_t  RXMAXP1;                           /*!< USB Maximum Receive Data Endpoint 1                                   */
  ...
  __IO uint8_t   RXTYPE1;                           /*!< USB Host Configure Receive Type Endpoint 1                            */
  __IO uint8_t   RXINTERVAL1;                       /*!< USB Host Receive Polling Interval Endpoint 1                          */
  __I  uint16_t  RESERVED27;                        /*!< RESERVED 2 BYTES                                                      */
  __IO uint16_t  TXMAXP2;                           /*!< USB Maximum Transmit Data Endpoint 2                   offset = 0x120 */
  ...
  __I  uint16_t  RESERVED28;                        /*!< RESERVED 2 BYTES                                                      */
  __IO uint16_t  TXMAXP3;                           /*!< USB Maximum Transmit Data Endpoint 3                   offset = 0x130 */
  ...
  __I  uint16_t  RESERVED29;                        /*!< RESERVED 2 BYTES                                                      */
  __IO uint16_t  TXMAXP4;                           /*!< USB Maximum Transmit Data Endpoint 4                   offset = 0x140 */
  ...
  __I  uint16_t  RESERVED30;                        /*!< RESERVED 2 BYTES                                                      */
  __IO uint16_t  TXMAXP5;                           /*!< USB Maximum Transmit Data Endpoint 5                   offset = 0x150 */
  ...
  __I  uint16_t  RESERVED31;                        /*!< RESERVED 2 BYTES                                                      */
  __IO uint16_t  TXMAXP6;                           /*!< USB Maximum Transmit Data Endpoint 6                   offset = 0x160 */
  ...
  __I  uint16_t  RESERVED32;                        /*!< RESERVED 2 BYTES                                                      */
  __IO uint16_t  TXMAXP7;                           /*!< USB Maximum Transmit Data Endpoint 7                   offset = 0x170 */
  ...
  __I  uint16_t  RESERVED58[11];                    /*!< RESERVED 22 BYTES                                                     */
  ...
  __I  uint16_t  RESERVED59[77];                    /*!< RESERVED 154 BYTES                                                    */
  ...
  __I  uint32_t  RESERVED60[4];                     /*!< RESERVED 16 BYTES                                                     */
  ...
  __I  uint32_t  RESERVED61[736];                   /*!< RESERVED 2944 BYTES                                                   */
...
//
//*****************************************************************************
#define USB_POWER_ISOUP         0x80  // Isochronous Update
#define USB_POWER_SOFTCONN      0x40  // Soft Connect/Disconnect
#define USB_POWER_HSENAB        0x20  // High Speed Enable
#define USB_POWER_HSMODE        0x10  // High Speed Enable
#define USB_POWER_RESET         0x08  // RESET Signaling
#define USB_POWER_RESUME        0x04  // RESUME Signaling
#define USB_POWER_SUSPEND       0x02  // SUSPEND Mode
#define USB_POWER_PWRDNPHY      0x01  // Power Down PHY
...
//
//*****************************************************************************
#define USB_TXIS_EP7            0x80  // TX Endpoint 7 Interrupt
#define USB_TXIS_EP6            0x40  // TX Endpoint 6 Interrupt
#define USB_TXIS_EP5            0x20  // TX Endpoint 5 Interrupt
#define USB_TXIS_EP4            0x10  // TX Endpoint 4 Interrupt
#define USB_TXIS_EP3            0x08  // TX Endpoint 3 Interrupt
#define USB_TXIS_EP2            0x04  // TX Endpoint 2 Interrupt
#define USB_TXIS_EP1            0x02  // TX Endpoint 1 Interrupt
#define USB_TXIS_EP0            0x01  // TX and RX Endpoint 0 Interrupt
...
//
//*****************************************************************************
#define USB_RXIS_EP7            0x80  // RX Endpoint 7 Interrupt
#define USB_RXIS_EP6            0x40  // RX Endpoint 6 Interrupt
#define USB_RXIS_EP5            0x20  // RX Endpoint 5 Interrupt
#define USB_RXIS_EP4            0x10  // RX Endpoint 4 Interrupt
#define USB_RXIS_EP3            0x08  // RX Endpoint 3 Interrupt
#define USB_RXIS_EP2            0x04  // RX Endpoint 2 Interrupt
#define USB_RXIS_EP1            0x02  // RX Endpoint 1 Interrupt
...
//
//*****************************************************************************
#define USB_TXIE_EP7            0x80  // TX Endpoint 7 Interrupt Enable
#define USB_TXIE_EP6            0x40  // TX Endpoint 6 Interrupt Enable
#define USB_TXIE_EP5            0x20  // TX Endpoint 5 Interrupt Enable
#define USB_TXIE_EP4            0x10  // TX Endpoint 4 Interrupt Enable
#define USB_TXIE_EP3            0x08  // TX Endpoint 3 Interrupt Enable
#define USB_TXIE_EP2            0x04  // TX Endpoint 2 Interrupt Enable
#define USB_TXIE_EP1            0x02  // TX Endpoint 1 Interrupt Enable
#define USB_TXIE_EP0            0x01  // TX and RX Endpoint 0 Interrupt
                                            // Enable
...
//
//*****************************************************************************
#define USB_RXIE_EP7            0x80  // RX Endpoint 7 Interrupt Enable
#define USB_RXIE_EP6            0x40  // RX Endpoint 6 Interrupt Enable
#define USB_RXIE_EP5            0x20  // RX Endpoint 5 Interrupt Enable
#define USB_RXIE_EP4            0x10  // RX Endpoint 4 Interrupt Enable
#define USB_RXIE_EP3            0x08  // RX Endpoint 3 Interrupt Enable
#define USB_RXIE_EP2            0x04  // RX Endpoint 2 Interrupt Enable
#define USB_RXIE_EP1            0x02  // RX Endpoint 1 Interrupt Enable
...
//
//*****************************************************************************
#define USB_IS_VBUSERR          0x80  // VBUS Error (OTG only)
#define USB_IS_SESREQ           0x40  // SESSION REQUEST (OTG only)
#define USB_IS_DISCON           0x20  // Session Disconnect (OTG only)
#define USB_IS_CONN             0x10  // Session Connect
#define USB_IS_SOF              0x08  // Start of Frame
#define USB_IS_BABBLE           0x04  // Babble Detected
#define USB_IS_RESET            0x04  // RESET Signaling Detected
#define USB_IS_RESUME           0x02  // RESUME Signaling Detected
#define USB_IS_SUSPEND          0x01  // SUSPEND Signaling Detected
...
//
//*****************************************************************************
#define USB_IE_VBUSERR          0x80  // Enable VBUS Error Interrupt (OTG
                                      // only)
#define USB_IE_SESREQ           0x40  // Enable Session Request (OTG
                                      // only)
#define USB_IE_DISCON           0x20  // Enable Disconnect Interrupt
#define USB_IE_CONN             0x10  // Enable Connect Interrupt
#define USB_IE_SOF              0x08  // Enable Start-of-Frame Interrupt
#define USB_IE_BABBLE           0x04  // Enable Babble Interrupt
#define USB_IE_RESET            0x04  // Enable RESET Interrupt
#define USB_IE_RESUME           0x02  // Enable RESUME Interrupt
#define USB_IE_SUSPND           0x01  // Enable SUSPEND Interrupt
...
//
//*****************************************************************************
#define USB_DEVCTL_DEV          0x80  // Device Mode (OTG only)
#define USB_DEVCTL_FSDEV        0x40  // Full-Speed Device Detected
#define USB_DEVCTL_LSDEV        0x20  // Low-Speed Device Detected
#define USB_DEVCTL_VBUS_M       0x18  // VBUS Level (OTG only)
#define USB_DEVCTL_VBUS_NONE    0x00  // Below SessionEnd
#define USB_DEVCTL_VBUS_SEND    0x08  // Above SessionEnd, below AValid
#define USB_DEVCTL_VBUS_AVALID  0x10  // Above AValid, below VBUSValid
#define USB_DEVCTL_VBUS_VALID   0x18  // Above VBUSValid
#define USB_DEVCTL_HOST         0x04  // Host Mode
#define USB_DEVCTL_HOSTREQ      0x02  // Host Request (OTG only)
#define USB_DEVCTL_SESSION      0x01  // Session Start/End (OTG only)
...
//
//*****************************************************************************
#define USB_CCONF_TXEDMA        0x02  // TX Early DMA Enable
#define USB_CCONF_RXEDMA        0x01  // TX Early DMA Enable
...
//
//*****************************************************************************
#define USB_TXFIFOSZ_DPB        0x10  // Double Packet Buffer Support
#define USB_TXFIFOSZ_SIZE_M     0x0F  // Max Packet Size
#define USB_TXFIFOSZ_SIZE_8     0x00  // 8
#define USB_TXFIFOSZ_SIZE_16    0x01  // 16
#define USB_TXFIFOSZ_SIZE_32    0x02  // 32
#define USB_TXFIFOSZ_SIZE_64    0x03  // 64
#define USB_TXFIFOSZ_SIZE_128   0x04  // 128
#define USB_TXFIFOSZ_SIZE_256   0x05  // 256
#define USB_TXFIFOSZ_SIZE_512   0x06  // 512
#define USB_TXFIFOSZ_SIZE_1024  0x07  // 1024
#define USB_TXFIFOSZ_SIZE_2048  0x08  // 2048
...
//
//*****************************************************************************
#define USB_RXFIFOSZ_DPB        0x10  // Double Packet Buffer Support
#define USB_RXFIFOSZ_SIZE_M     0x0F  // Max Packet Size
#define USB_RXFIFOSZ_SIZE_8     0x00  // 8
#define USB_RXFIFOSZ_SIZE_16    0x01  // 16
#define USB_RXFIFOSZ_SIZE_32    0x02  // 32
#define USB_RXFIFOSZ_SIZE_64    0x03  // 64
#define USB_RXFIFOSZ_SIZE_128   0x04  // 128
#define USB_RXFIFOSZ_SIZE_256   0x05  // 256
#define USB_RXFIFOSZ_SIZE_512   0x06  // 512
#define USB_RXFIFOSZ_SIZE_1024  0x07  // 1024
#define USB_RXFIFOSZ_SIZE_2048  0x08  // 2048
...
//
//*****************************************************************************
#define USB_TXTYPE1_SPEED_M     0xC0  // Operating Speed
#define USB_TXTYPE1_SPEED_DFLT  0x00  // Default
#define USB_TXTYPE1_SPEED_HIGH  0x40  // High
#define USB_TXTYPE1_SPEED_FULL  0x80  // Full
#define USB_TXTYPE1_SPEED_LOW   0xC0  // Low
#define USB_TXTYPE1_PROTO_M     0x30  // Protocol
#define USB_TXTYPE1_PROTO_CTRL  0x00  // Control
#define USB_TXTYPE1_PROTO_ISOC  0x10  // Isochronous
#define USB_TXTYPE1_PROTO_BULK  0x20  // Bulk
#define USB_TXTYPE1_PROTO_INT   0x30  // Interrupt
#define USB_TXTYPE1_TEP_M       0x0F  // Target Endpoint Number
...
//
//*****************************************************************************
#define USB_EP_0                0x00  // Endpoint 0
#define USB_EP_1                0x10  // Endpoint 1
#define USB_EP_2                0x20  // Endpoint 2
#define USB_EP_3                0x30  // Endpoint 3
#define USB_EP_4                0x40  // Endpoint 4
#define USB_EP_5                0x50  // Endpoint 5
#define USB_EP_6                0x60  // Endpoint 6
#define USB_EP_7                0x70  // Endpoint 7
...
//
//*****************************************************************************
#define USB_FIFO_SZ_8           0x00  // 8 byte FIFO
#define USB_FIFO_SZ_16          0x01  // 16 byte FIFO
#define USB_FIFO_SZ_32          0x02  // 32 byte FIFO
#define USB_FIFO_SZ_64          0x03  // 64 byte FIFO
#define USB_FIFO_SZ_128         0x04  // 128 byte FIFO
#define USB_FIFO_SZ_256         0x05  // 256 byte FIFO
#define USB_FIFO_SZ_512         0x06  // 512 byte FIFO
#define USB_FIFO_SZ_1024        0x07  // 1024 byte FIFO
#define USB_FIFO_SZ_2048        0x08  // 2048 byte FIFO
