...
#define LOG_D(fmt, args...) \
    do {printf(PFORMAT_D,LOG_D_BASE_ARGS); printf(fmt,##args); printf("\n");} while(0)
#else
#define LOG_D(fmt, args...)
#endif
...
#define LOG_I(fmt, args...) \
    do {printf(PFORMAT_I ,LOG_I_BASE_ARGS); printf(fmt,##args); printf("\n");} while(0)
#else
#define LOG_I(fmt, args...)
#endif
...
#define LOG_W(fmt, args...) \
    do {printf(PFORMAT_W,LOG_W_BASE_ARGS); printf(fmt,##args); printf("\n");} while(0)
#else
#define LOG_W(fmt, args...)
#endif
...
#define LOG_E(fmt, args...) \
    do {printf(PFORMAT_E,LOG_E_BASE_ARGS); printf(fmt,##args); printf("\n");} while(0)
#else
#define LOG_E(fmt, args...)
#endif
