...
const char BootVersion[32] __attribute__((section(".version"))) = "1.10.19_build_2024.10.29.17.00";
const char Boot_compile_date[32] __attribute__((section(".compiledate"))) = __DATE__; 
const char Boot_compile_time[32] __attribute__((section(".compiletime"))) = __TIME__;
