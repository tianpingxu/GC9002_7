...
#ifndef __GC90XX_HAL_UART_H__

#define __GC90XX_HAL_UART_H__
...
#include <gc90xx_hal_def.h>
 ...
 typedef struct
 {
   ...
   uint16_t HwFlowCtl;           /*!< Specifies wether the hardware flow control mode is enabled or disabled.
                                            This parameter can be a value of @ref UART_Hardware_Flow_Control */
   uint16_t ClockSource;         /*!< clock source. This parameter can be a value of 0~1 */
 } UART_InitTypeDef;
...
typedef struct __UART_HandleTypeDef
{
    ...
    void (* IDLECallback)(struct __UART_HandleTypeDef *huart);              /*!< UART IDLE Callback                    */
...
typedef enum
{
  ...
  HAL_UART_IDLE_CB_ID                    = 0x09U,    /*!< UART IDLE Callback ID                    */
...
#define IS_UART_HWFLOW_INSTANCE         IS_UART_HALFDUPLEX_INSTANCE

#define IS_UART_ALL_PERIPH              IS_UART_HALFDUPLEX_INSTANCE
...
/** @defgroup UART_Stop_Bits UART Number of Stop Bits
  * @{
  */
#define UART_STOPBITS_1                     ((uint32_t)UART_CR2_STOP_1)
#define UART_STOPBITS_0_5                   ((uint32_t)UART_CR2_STOP_0_5)
#define UART_STOPBITS_2                     ((uint32_t)UART_CR2_STOP_2)
#define UART_STOPBITS_1_5                   ((uint32_t)UART_CR2_STOP_1_5)
...
#define UART_PARITY_EVEN                    ((uint32_t)UART_CR1_PCE)
#define UART_PARITY_ODD                     ((uint32_t)(UART_CR1_PCE | UART_CR1_PS))
...
#define UART_MODE_TX_RX                     ((uint32_t)(UART_CR1_TE | UART_CR1_RE))
...
#define UART_HWCONTROL_RTS                   ((uint32_t)UART_CR3_RTSE)
#define UART_HWCONTROL_CTS                   ((uint32_t)UART_CR3_CTSE)
#define UART_HWCONTROL_RTS_CTS               ((uint32_t)(UART_CR3_RTSE | UART_CR3_CTSE))
...
#define UART_WAKEUPMETHOD_ADDRESSMARK             ((uint32_t)UART_CR1_WAKE)
...
#define IS_UART_CLEAR_FLAG(FLAG) ((((FLAG) & (uint16_t)0xFC9F) == 0x00) && ((FLAG) != (uint16_t)0x00))
#define IS_UART_PERIPH_FLAG(PERIPH, UART_FLAG) ((((*(uint32_t*)&(PERIPH)) != UART4_BASE) &&\
                                                  ((*(uint32_t*)&(PERIPH)) != UART5_BASE)) \
                                                  || ((UART_FLAG) != UART_FLAG_CTS)) 
#define IS_UART_BAUDRATE(BAUDRATE)                      (((BAUDRATE) > 0) && ((BAUDRATE) <= BSP_UART_BAUDRATE_MAX))
...
#define UART_IT_PE                       ((uint32_t)(UART_CR1_REG_INDEX << 28U | UART_CR1_PEIE))
#define UART_IT_TXE                      ((uint32_t)(UART_CR1_REG_INDEX << 28U | UART_CR1_TXEIE))
#define UART_IT_TC                       ((uint32_t)(UART_CR1_REG_INDEX << 28U | UART_CR1_TCIE))
#define UART_IT_RXNE                     ((uint32_t)(UART_CR1_REG_INDEX << 28U | UART_CR1_RXNEIE))
#define UART_IT_IDLE                     ((uint32_t)(UART_CR1_REG_INDEX << 28U | UART_CR1_IDLEIE))

#define UART_IT_LBD                      ((uint32_t)(UART_CR2_REG_INDEX << 28U | UART_CR2_LBDIE))

#define UART_IT_CTS                      ((uint32_t)(UART_CR3_REG_INDEX << 28U | UART_CR3_CTSIE))
#define UART_IT_ERR                      ((uint32_t)(UART_CR3_REG_INDEX << 28U | UART_CR3_EIE))
...
uint16_t HAL_UART_ReceiveData(UART_TypeDef* UARTx);
void HAL_UART_SendData(UART_TypeDef* UARTx, uint16_t Data);

#endif
#ifdef __cplusplus
}
#endif
#endif /* __GC90XX_HAL_UART_H__ */
