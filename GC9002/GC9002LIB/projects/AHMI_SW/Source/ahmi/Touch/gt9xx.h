...
#define I2C_DELAY_1_MS              ((uint32_t)13000)
...
typedef enum
{
    GT9xxTouch_GetTouchState = 0,
	GT9xxTouch_GetPosition,
	GT9xxTouch_ClearFlag
}GT9xxTouch_teRtpMainSM;
...
extern void GM7150Init(void);
extern int32_t General_I2C_Write(uint8_t client_addr,uint8_t *buf,int32_t len);
extern int32_t General_I2C_Read(uint8_t client_addr, uint8_t *buf, int32_t len);
#endif
