...
#ifndef __GC90xx_HAL_TIM_EX_H__

#define __GC90xx_HAL_TIM_EX_H__
...
/** @defgroup TIMEx_Private_Macros TIM Extended Private Macros
  ...
  */
#if defined(SPDIFRX)
#define IS_TIM_REMAP(INSTANCE, TIM_REMAP)   1
#else
#define IS_TIM_REMAP(INSTANCE, TIM_REMAP)    0
#endif /* SPDIFRX */
