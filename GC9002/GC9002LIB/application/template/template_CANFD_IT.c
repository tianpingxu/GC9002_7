...
void TEST_HAL_CANFD_RxMsgCallback(CANFD_HandleTypeDef *hcanfd)
{
    while(HAL_CANFD_GetRxBuffStatus(hcanfd) != 0)
    {
        if(HAL_CANFD_GetRxMessage_IT(hcanfd, &rx_msg) == HAL_OK)
        {
...
void TEST_HAL_CANFD_RxBuffOverrunCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_RxBuffFullCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_RxBuffAlmostFullCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_TxPriClptCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_TxSecClptCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_ErrorCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_AbortCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_PassiveErrorCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_ArbitrationLostCallback(CANFD_HandleTypeDef *hcanfd)
{}
void TEST_HAL_CANFD_BusErrorCallback(CANFD_HandleTypeDef *hcanfd)
{}
int main(void)
{
    ...
    /* CAN 筛选器初始化 
     * FilterMaskId的bit=1：无视Id对应的bit位；
     * FilterMaskId的bit=0：Id的bit位的值必须和FilterId的对应bit位值一致
     */
    ...
    HAL_CANFD_RegisterCallback(&hcanfd, HAL_CANFD_RX_MSG_CB_ID, TEST_HAL_CANFD_RxMsgCallback);
