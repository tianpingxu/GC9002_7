...
//2020/3/9
////////////////////////////////////////////////////////////////////////////////
#ifndef KEYBOARDCONTAINER__H
#define KEYBOARDCONTAINER__H
...
public:
	...
	funcStatus setKBHint(
		WidgetClassPtr p_wptr, 
		u32 value
	);

	//change hints page
	funcStatus setKBHintsPage(
		WidgetClassPtr p_wptr, 
		u32 step,
		u8 direction
	);

	//get keyboard value from this container and set to target tag
	funcStatus getKB(
		WidgetClassPtr p_wptr,
		u16 tagId
	);
